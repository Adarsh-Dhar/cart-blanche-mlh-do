...
function extractStacksAddress(result: unknown): string | null {
  ...
  if (Array.isArray(addresses)) {
    const entry = (addresses as Array<{ address?: string }>).find(
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", position: "relative" }}>
        ...
        >
          <Link
            ...
            onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = "hsl(66,100%,50%)")}
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          >
            Mint{" "}
            <span style={{ color: "hsl(66,100%,50%)", textShadow: "0 0 30px hsl(66,100%,50%,0.4)" }}>
              USDCx
            </span>{" "}
            tokens
          </h1>
          <p style={{ color: "#4a5568", fontSize: 14, marginTop: 12, lineHeight: 1.7, maxWidth: 480 }}>
            Mint testnet USDCx tokens to fund your Smart Wallet for agentic shopping.
            Requires the deployer wallet ({DEPLOYER.slice(0, 12)}…).
          </p>
        </div>
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: 11, color: "#4a5568", textTransform: "uppercase" as const, letterSpacing: "0.1em", marginBottom: 4 }}>
              Deployed Contract
            </div>
          ...
          <a
            href={`https://explorer.hiro.so/address/${DEPLOYER}.${CONTRACT_NAME}?chain=testnet`}
            target="_blank"
        ...
        {!stacksAddress ? (
          ...
          >
            ...
            <p style={{ fontSize: 14, color: "#64748b", marginBottom: 20 }}>
              Connect your Leather or Xverse wallet to mint USDCx tokens.
            </p>
            <button
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 11, color: "hsl(66,100%,50%)", fontWeight: 700, marginBottom: 2 }}>
                Wallet Connected
              </div>
              <div
                style={{
        ...
        <div
          style={{
            ...
            borderRadius: 16,
            padding:      28,
            boxShadow:    "0 0 60px hsl(66,100%,50%,0.04)",
            marginBottom: 20,
          }}
        >
          <div
          ...
          <div style={{ marginBottom: 20 }}>
              ...
              {PRESETS.map((p) => (
                <button
                  ...
                  style={{
                    ...
                    fontWeight:   600,
                    fontFamily:   "inherit",
                    background:   amount === String(p) ? "hsl(66,100%,50%,0.15)" : "#080c10",
                    border:       `1px solid ${amount === String(p) ? "hsl(66,100%,50%,0.5)" : "#1a2332"}`,
                    color:        amount === String(p) ? "hsl(66,100%,50%)" : "#64748b",
                    cursor:       "pointer",
                  }}
                >
                  {p.toLocaleString()}
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                onFocus={(e) => ((e.target as HTMLElement).style.borderColor = "hsl(66,100%,50%,0.5)")}
                onBlur={(e)  => ((e.target as HTMLElement).style.borderColor = "#1a2332")}
              />
            </div>
            {atomicDisplay && (
              <div style={{ fontSize: 11, color: "#4a5568", marginTop: 6, fontFamily: "monospace" }}>
                = {atomicDisplay} atomic units (6 decimals)
              </div>
            )}
          </div>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            {recipient && (
              ...
              >
                <span
                  style={{ width: 6, height: 6, borderRadius: "50%", background: "#00ff9d", display: "inline-block" }}
                />
                Minting to:{" "}
          ...
          >
            {isLoading ? (
              <>
                ...
                {status === "connecting" ? "Connecting…" : "Waiting for signature…"}
              </>
            ) : (
              <>
                <Zap size={16} />
                Mint {parsedAmt > 0 ? `${parsedAmt.toLocaleString()} ` : ""}USDCx
                <ArrowRight size={14} />
              </>
            )}
          </button>
          {!stacksAddress && (
            <p style={{ textAlign: "center" as const, fontSize: 11, color: "#2d3748", marginTop: 12 }}>
        ...
        {status === "success" && result && (
          <div
            style={{
              ...
              padding:      24,
              marginBottom: 20,
              boxShadow:    "0 0 40px hsl(66,100%,50%,0.08)",
            }}
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              ...
              <div>
                <div style={{ fontSize: 15, fontWeight: 700, color: "hsl(66,100%,50%)" }}>
                  {result.amount.toLocaleString()} USDCx minted!
                </div>
                <div style={{ fontSize: 11, color: "#4a5568", marginTop: 2 }}>
                  Transaction submitted · balance updates once confirmed (~30s)
                </div>
              </div>
            </div>
        ...
        >
          ...
          {[
            {
              icon:  Coins,
              title: "SIP-010 Fungible Token",
              desc:  "USDCx is a Stacks-native bridged USDC with 6 decimal precision, deployed on Stacks Testnet.",
            },
            {
              icon:  Zap,
              title: "governance-mint Function",
              desc:  "Only the deployer wallet can call governance-mint. This is a testnet-only convenience function for seeding wallets.",
            },
            {
              icon:  Wallet,
              title: "Powering Cart Blanche",
              desc:  "USDCx is used by the shopping agent to settle purchases autonomously via SIP-010 contract calls on Stacks.",
            },
          ...
          >
            <strong style={{ color: "#64748b" }}>Testnet only:</strong> USDCx on Stacks Testnet
            has no real monetary value. Use it freely for testing Cart Blanche.
          </div>
        </div>
      </div>
